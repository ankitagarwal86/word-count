...
public class WordCountService {
    ...
    */
    public long findWordsGreaterThanCertainLength(List<String> words, int length) {
        var characterCountRule = new CharacterCountRule(length, null);
        return characterCountRule.onNext(words.stream()).count();
    }
     ...
     */
    public List<String> findWordsWithMatchingPrefix(List<String> words, String prefix) {
